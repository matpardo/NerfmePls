    <div class="row">
      <div class="col-sm-10 col-sm-offset-1">
        <legend>Hoteles/Alquileres</legend>        
      </div>
    </div>  
    <div class="row">
      <div class="col-sm-6 col-sm-offset-1">
        <?php echo img(array('class' =>'img-responsive','src' =>'/assets/img/img_rent.jpg')); ?>
      </div>
      <div class="col-sm-4">
  ...
  <script>
    ...
    $(document).ready(function(){      
      $('body').on('change','#country_id',function(){
        ...
        window.location.href = "<?php echo site_url('/element/rent/') ?>"+'/'+country_id;
      });    
    });
  </script>     
